...
declare interface jagent extends jhandle {__jagent: never;}
declare interface jevent extends jagent {__jevent: never;}
declare interface jplayer extends jagent {__jplayer: never;}
declare interface jwidget extends jagent {__jwidget: never;}
declare interface junit extends jwidget {__junit: never;}
declare interface jdestructable extends jwidget {__jdestructable: never;}
declare interface jitem extends jwidget {__jitem: never;}
declare interface jability extends jagent {__jability: never;}
declare interface jbuff extends jability {__jbuff: never;}
declare interface jforce extends jagent {__jforce: never;}
declare interface jgroup extends jagent {__jgroup: never;}
declare interface jtrigger extends jagent {__jtrigger: never;}
declare interface jtriggercondition extends jagent {__jtriggercondition: never;}
declare interface jtriggeraction extends jhandle {__jtriggeraction: never;}
declare interface jtimer extends jagent {__jtimer: never;}
declare interface jlocation extends jagent {__jlocation: never;}
declare interface jregion extends jagent {__jregion: never;}
declare interface jrect extends jagent {__jrect: never;}
declare interface jboolexpr extends jagent {__jboolexpr: never;}
declare interface jsound extends jagent {__jsound: never;}
declare interface jconditionfunc extends jboolexpr {__jconditionfunc: never;}
declare interface jfilterfunc extends jboolexpr {__jfilterfunc: never;}
declare interface junitpool extends jhandle {__junitpool: never;}
declare interface jitempool extends jhandle {__jitempool: never;}
declare interface jrace extends jhandle {__jrace: never;}
declare interface jalliancetype extends jhandle {__jalliancetype: never;}
declare interface jracepreference extends jhandle {__jracepreference: never;}
declare interface jgamestate extends jhandle {__jgamestate: never;}
declare interface jigamestate extends jgamestate {__jigamestate: never;}
declare interface jfgamestate extends jgamestate {__jfgamestate: never;}
declare interface jplayerstate extends jhandle {__jplayerstate: never;}
declare interface jplayerscore extends jhandle {__jplayerscore: never;}
declare interface jplayergameresult extends jhandle {__jplayergameresult: never;}
declare interface junitstate extends jhandle {__junitstate: never;}
declare interface jaidifficulty extends jhandle {__jaidifficulty: never;}
declare interface jeventid extends jhandle {__jeventid: never;}
declare interface jgameevent extends jeventid {__jgameevent: never;}
declare interface jplayerevent extends jeventid {__jplayerevent: never;}
declare interface jplayerunitevent extends jeventid {__jplayerunitevent: never;}
declare interface junitevent extends jeventid {__junitevent: never;}
declare interface jlimitop extends jeventid {__jlimitop: never;}
declare interface jwidgetevent extends jeventid {__jwidgetevent: never;}
declare interface jdialogevent extends jeventid {__jdialogevent: never;}
declare interface junittype extends jhandle {__junittype: never;}
declare interface jgamespeed extends jhandle {__jgamespeed: never;}
declare interface jgamedifficulty extends jhandle {__jgamedifficulty: never;}
declare interface jgametype extends jhandle {__jgametype: never;}
declare interface jmapflag extends jhandle {__jmapflag: never;}
declare interface jmapvisibility extends jhandle {__jmapvisibility: never;}
declare interface jmapsetting extends jhandle {__jmapsetting: never;}
declare interface jmapdensity extends jhandle {__jmapdensity: never;}
declare interface jmapcontrol extends jhandle {__jmapcontrol: never;}
declare interface jminimapicon extends jhandle {__jminimapicon: never;}
declare interface jplayerslotstate extends jhandle {__jplayerslotstate: never;}
declare interface jvolumegroup extends jhandle {__jvolumegroup: never;}
declare interface jcamerafield extends jhandle {__jcamerafield: never;}
declare interface jcamerasetup extends jhandle {__jcamerasetup: never;}
declare interface jplayercolor extends jhandle {__jplayercolor: never;}
declare interface jplacement extends jhandle {__jplacement: never;}
declare interface jstartlocprio extends jhandle {__jstartlocprio: never;}
declare interface jraritycontrol extends jhandle {__jraritycontrol: never;}
declare interface jblendmode extends jhandle {__jblendmode: never;}
declare interface jtexmapflags extends jhandle {__jtexmapflags: never;}
declare interface jeffect extends jagent {__jeffect: never;}
declare interface jeffecttype extends jhandle {__jeffecttype: never;}
declare interface jweathereffect extends jhandle {__jweathereffect: never;}
declare interface jterraindeformation extends jhandle {__jterraindeformation: never;}
declare interface jfogstate extends jhandle {__jfogstate: never;}
declare interface jfogmodifier extends jagent {__jfogmodifier: never;}
declare interface jdialog extends jagent {__jdialog: never;}
declare interface jbutton extends jagent {__jbutton: never;}
declare interface jquest extends jagent {__jquest: never;}
declare interface jquestitem extends jagent {__jquestitem: never;}
declare interface jdefeatcondition extends jagent {__jdefeatcondition: never;}
declare interface jtimerdialog extends jagent {__jtimerdialog: never;}
declare interface jleaderboard extends jagent {__jleaderboard: never;}
declare interface jmultiboard extends jagent {__jmultiboard: never;}
declare interface jmultiboarditem extends jagent {__jmultiboarditem: never;}
declare interface jtrackable extends jagent {__jtrackable: never;}
declare interface jgamecache extends jagent {__jgamecache: never;}
declare interface jversion extends jhandle {__jversion: never;}
declare interface jitemtype extends jhandle {__jitemtype: never;}
declare interface jtexttag extends jhandle {__jtexttag: never;}
declare interface jattacktype extends jhandle {__jattacktype: never;}
declare interface jdamagetype extends jhandle {__jdamagetype: never;}
declare interface jweapontype extends jhandle {__jweapontype: never;}
declare interface jsoundtype extends jhandle {__jsoundtype: never;}
declare interface jlightning extends jhandle {__jlightning: never;}
declare interface jpathingtype extends jhandle {__jpathingtype: never;}
declare interface jmousebuttontype extends jhandle {__jmousebuttontype: never;}
declare interface janimtype extends jhandle {__janimtype: never;}
declare interface jsubanimtype extends jhandle {__jsubanimtype: never;}
declare interface jimage extends jhandle {__jimage: never;}
declare interface jubersplat extends jhandle {__jubersplat: never;}
declare interface jhashtable extends jagent {__jhashtable: never;}
declare interface jframehandle extends jhandle {__jframehandle: never;}
declare interface joriginframetype extends jhandle {__joriginframetype: never;}
declare interface jframepointtype extends jhandle {__jframepointtype: never;}
declare interface jtextaligntype extends jhandle {__jtextaligntype: never;}
declare interface jframeeventtype extends jhandle {__jframeeventtype: never;}
declare interface joskeytype extends jhandle {__joskeytype: never;}
declare interface jabilityintegerfield extends jhandle {__jabilityintegerfield: never;}
declare interface jabilityrealfield extends jhandle {__jabilityrealfield: never;}
declare interface jabilitybooleanfield extends jhandle {__jabilitybooleanfield: never;}
declare interface jabilitystringfield extends jhandle {__jabilitystringfield: never;}
declare interface jabilityintegerlevelfield extends jhandle {__jabilityintegerlevelfield: never;}
declare interface jabilityreallevelfield extends jhandle {__jabilityreallevelfield: never;}
declare interface jabilitybooleanlevelfield extends jhandle {__jabilitybooleanlevelfield: never;}
declare interface jabilitystringlevelfield extends jhandle {__jabilitystringlevelfield: never;}
declare interface jabilityintegerlevelarrayfield extends jhandle {__jabilityintegerlevelarrayfield: never;}
declare interface jabilityreallevelarrayfield extends jhandle {__jabilityreallevelarrayfield: never;}
declare interface jabilitybooleanlevelarrayfield extends jhandle {__jabilitybooleanlevelarrayfield: never;}
declare interface jabilitystringlevelarrayfield extends jhandle {__jabilitystringlevelarrayfield: never;}
declare interface junitintegerfield extends jhandle {__junitintegerfield: never;}
declare interface junitrealfield extends jhandle {__junitrealfield: never;}
declare interface junitbooleanfield extends jhandle {__junitbooleanfield: never;}
declare interface junitstringfield extends jhandle {__junitstringfield: never;}
declare interface junitweaponintegerfield extends jhandle {__junitweaponintegerfield: never;}
declare interface junitweaponrealfield extends jhandle {__junitweaponrealfield: never;}
declare interface junitweaponbooleanfield extends jhandle {__junitweaponbooleanfield: never;}
declare interface junitweaponstringfield extends jhandle {__junitweaponstringfield: never;}
declare interface jitemintegerfield extends jhandle {__jitemintegerfield: never;}
declare interface jitemrealfield extends jhandle {__jitemrealfield: never;}
declare interface jitembooleanfield extends jhandle {__jitembooleanfield: never;}
declare interface jitemstringfield extends jhandle {__jitemstringfield: never;}
declare interface jmovetype extends jhandle {__jmovetype: never;}
declare interface jtargetflag extends jhandle {__jtargetflag: never;}
declare interface jarmortype extends jhandle {__jarmortype: never;}
declare interface jheroattribute extends jhandle {__jheroattribute: never;}
declare interface jdefensetype extends jhandle {__jdefensetype: never;}
declare interface jregentype extends jhandle {__jregentype: never;}
declare interface junitcategory extends jhandle {__junitcategory: never;}
declare interface jpathingflag extends jhandle {__jpathingflag: never;}
declare interface jcommandbuttoneffect extends jhandle {__jcommandbuttoneffect: never;}
...
declare function SetStartLocPrio(whichStartLoc: number, prioSlotIndex: number, otherStartLocIndex: number, priority: jstartlocprio): void;
...
declare function SetEnemyStartLocPrio(whichStartLoc: number, prioSlotIndex: number, otherStartLocIndex: number, priority: jstartlocprio): void;
...
declare function SetPlayerAlliance(sourcePlayer: jplayer, otherPlayer: jplayer, whichAllianceSetting: jalliancetype, value: boolean): void;
declare function SetPlayerTaxRate(sourcePlayer: jplayer, otherPlayer: jplayer, whichResource: jplayerstate, rate: number): void;
declare function SetPlayerRacePreference(whichPlayer: jplayer, whichRacePreference: jracepreference): void;
...
declare function GetPlayerTaxRate(sourcePlayer: jplayer, otherPlayer: jplayer, whichResource: jplayerstate): number;
...
declare function TimerStart(whichTimer: jtimer, timeout: number, periodic: boolean, handlerFunc?: () => void): void;
...
declare function GroupEnumUnitsOfPlayer(whichGroup: jgroup, whichPlayer: jplayer, filter: jboolexpr): void;
declare function GroupEnumUnitsOfTypeCounted(whichGroup: jgroup, unitname: string, filter: jboolexpr, countLimit: number): void;
declare function GroupEnumUnitsInRect(whichGroup: jgroup, r: jrect, filter: jboolexpr): void;
declare function GroupEnumUnitsInRectCounted(whichGroup: jgroup, r: jrect, filter: jboolexpr, countLimit: number): void;
declare function GroupEnumUnitsInRange(whichGroup: jgroup, x: number, y: number, radius: number, filter: jboolexpr): void;
declare function GroupEnumUnitsInRangeOfLoc(whichGroup: jgroup, whichLocation: jlocation, radius: number, filter: jboolexpr): void;
declare function GroupEnumUnitsInRangeCounted(whichGroup: jgroup, x: number, y: number, radius: number, filter: jboolexpr, countLimit: number): void;
declare function GroupEnumUnitsInRangeOfLocCounted(whichGroup: jgroup, whichLocation: jlocation, radius: number, filter: jboolexpr, countLimit: number): void;
declare function GroupEnumUnitsSelected(whichGroup: jgroup, whichPlayer: jplayer, filter: jboolexpr): void;
...
declare function GroupPointOrderLoc(whichGroup: jgroup, order: string, whichLocation: jlocation): boolean;
declare function GroupPointOrderById(whichGroup: jgroup, order: number, x: number, y: number): boolean;
declare function GroupPointOrderByIdLoc(whichGroup: jgroup, order: number, whichLocation: jlocation): boolean;
declare function GroupTargetOrder(whichGroup: jgroup, order: string, targetWidget: jwidget): boolean;
declare function GroupTargetOrderById(whichGroup: jgroup, order: number, targetWidget: jwidget): boolean;
...
declare function ForceEnumPlayersCounted(whichForce: jforce, filter: jboolexpr, countLimit: number): void;
...
declare function SetRect(whichRect: jrect, minx: number, miny: number, maxx: number, maxy: number): void;
...
declare function TriggerRegisterVariableEvent(whichTrigger: jtrigger, varName: string, opcode: jlimitop, limitval: number): jevent;
declare function TriggerRegisterTimerEvent(whichTrigger: jtrigger, timeout: number, periodic: boolean): jevent;
declare function TriggerRegisterTimerExpireEvent(whichTrigger: jtrigger, t: jtimer): jevent;
declare function TriggerRegisterGameStateEvent(whichTrigger: jtrigger, whichState: jgamestate, opcode: jlimitop, limitval: number): jevent;
declare function TriggerRegisterDialogEvent(whichTrigger: jtrigger, whichDialog: jdialog): jevent;
declare function TriggerRegisterDialogButtonEvent(whichTrigger: jtrigger, whichButton: jbutton): jevent;
declare function GetEventGameState(): jgamestate;
declare function TriggerRegisterGameEvent(whichTrigger: jtrigger, whichGameEvent: jgameevent): jevent;
declare function GetWinningPlayer(): jplayer;
declare function TriggerRegisterEnterRegion(whichTrigger: jtrigger, whichRegion: jregion, filter: jboolexpr): jevent;
declare function GetTriggeringRegion(): jregion;
declare function GetEnteringUnit(): junit;
declare function TriggerRegisterLeaveRegion(whichTrigger: jtrigger, whichRegion: jregion, filter: jboolexpr): jevent;
...
declare function TriggerRegisterCommandEvent(whichTrigger: jtrigger, whichAbility: number, order: string): jevent;
declare function TriggerRegisterUpgradeCommandEvent(whichTrigger: jtrigger, whichUpgrade: number): jevent;
...
declare function TriggerRegisterPlayerEvent(whichTrigger: jtrigger, whichPlayer: jplayer, whichPlayerEvent: jplayerevent): jevent;
declare function GetTriggerPlayer(): jplayer;
declare function TriggerRegisterPlayerUnitEvent(whichTrigger: jtrigger, whichPlayer: jplayer, whichPlayerUnitEvent: jplayerunitevent, filter: jboolexpr): jevent;
...
declare function TriggerRegisterPlayerAllianceChange(whichTrigger: jtrigger, whichPlayer: jplayer, whichAlliance: jalliancetype): jevent;
declare function TriggerRegisterPlayerStateEvent(whichTrigger: jtrigger, whichPlayer: jplayer, whichState: jplayerstate, opcode: jlimitop, limitval: number): jevent;
declare function GetEventPlayerState(): jplayerstate;
declare function TriggerRegisterPlayerChatEvent(whichTrigger: jtrigger, whichPlayer: jplayer, chatMessageToDetect: string, exactMatchOnly: boolean): jevent;
...
declare function TriggerRegisterUnitStateEvent(whichTrigger: jtrigger, whichUnit: junit, whichState: junitstate, opcode: jlimitop, limitval: number): jevent;
declare function GetEventUnitState(): junitstate;
declare function TriggerRegisterUnitEvent(whichTrigger: jtrigger, whichUnit: junit, whichEvent: junitevent): jevent;
...
declare function TriggerRegisterFilterUnitEvent(whichTrigger: jtrigger, whichUnit: junit, whichEvent: junitevent, filter: jboolexpr): jevent;
declare function GetEventTargetUnit(): junit;
declare function TriggerRegisterUnitInRange(whichTrigger: jtrigger, whichUnit: junit, range: number, filter: jboolexpr): jevent;
declare function TriggerAddCondition(whichTrigger: jtrigger, condition: jboolexpr): jtriggercondition;
declare function TriggerRemoveCondition(whichTrigger: jtrigger, whichCondition: jtriggercondition): void;
...
declare function CreateDestructable(objectid: number, x: number, y: number, face: number, scale: number, variation: number): jdestructable;
declare function CreateDestructableZ(objectid: number, x: number, y: number, z: number, face: number, scale: number, variation: number): jdestructable;
declare function CreateDeadDestructable(objectid: number, x: number, y: number, face: number, scale: number, variation: number): jdestructable;
declare function CreateDeadDestructableZ(objectid: number, x: number, y: number, z: number, face: number, scale: number, variation: number): jdestructable;
...
declare function CreateUnitByName(whichPlayer: jplayer, unitname: string, x: number, y: number, face: number): junit;
declare function CreateUnitAtLoc(id: jplayer, unitid: number, whichLocation: jlocation, face: number): junit;
declare function CreateUnitAtLocByName(id: jplayer, unitname: string, whichLocation: jlocation, face: number): junit;
declare function CreateCorpse(whichPlayer: jplayer, unitid: number, x: number, y: number, face: number): junit;
...
declare function SetUnitScale(whichUnit: junit, scaleX: number, scaleY: number, scaleZ: number): void;
...
declare function SetUnitVertexColor(whichUnit: junit, red: number, green: number, blue: number, alpha: number): void;
...
declare function SetUnitAnimationWithRarity(whichUnit: junit, whichAnimation: string, rarity: jraritycontrol): void;
declare function AddUnitAnimationProperties(whichUnit: junit, animProperties: string, add: boolean): void;
declare function SetUnitLookAt(whichUnit: junit, whichBone: string, lookAtTarget: junit, offsetX: number, offsetY: number, offsetZ: number): void;
...
declare function UnitDropItemPoint(whichUnit: junit, whichItem: jitem, x: number, y: number): boolean;
...
declare function IsUnitInRangeLoc(whichUnit: junit, whichLocation: jlocation, distance: number): boolean;
...
declare function UnitMakeAbilityPermanent(whichUnit: junit, permanent: boolean, abilityId: number): boolean;
declare function UnitRemoveBuffs(whichUnit: junit, removePositive: boolean, removeNegative: boolean): void;
declare function UnitRemoveBuffsEx(whichUnit: junit, removePositive: boolean, removeNegative: boolean, magic: boolean, physical: boolean, timedLife: boolean, aura: boolean, autoDispel: boolean): void;
declare function UnitHasBuffsEx(whichUnit: junit, removePositive: boolean, removeNegative: boolean, magic: boolean, physical: boolean, timedLife: boolean, aura: boolean, autoDispel: boolean): boolean;
declare function UnitCountBuffsEx(whichUnit: junit, removePositive: boolean, removeNegative: boolean, magic: boolean, physical: boolean, timedLife: boolean, aura: boolean, autoDispel: boolean): number;
...
declare function UnitDamagePoint(whichUnit: junit, delay: number, radius: number, x: number, y: number, amount: number, attack: boolean, ranged: boolean, attackType: jattacktype, damageType: jdamagetype, weaponType: jweapontype): boolean;
declare function UnitDamageTarget(whichUnit: junit, target: jwidget, amount: number, attack: boolean, ranged: boolean, attackType: jattacktype, damageType: jdamagetype, weaponType: jweapontype): boolean;
...
declare function IssuePointOrderLoc(whichUnit: junit, order: string, whichLocation: jlocation): boolean;
declare function IssuePointOrderById(whichUnit: junit, order: number, x: number, y: number): boolean;
declare function IssuePointOrderByIdLoc(whichUnit: junit, order: number, whichLocation: jlocation): boolean;
declare function IssueTargetOrder(whichUnit: junit, order: string, targetWidget: jwidget): boolean;
declare function IssueTargetOrderById(whichUnit: junit, order: number, targetWidget: jwidget): boolean;
declare function IssueInstantPointOrder(whichUnit: junit, order: string, x: number, y: number, instantTargetWidget: jwidget): boolean;
declare function IssueInstantPointOrderById(whichUnit: junit, order: number, x: number, y: number, instantTargetWidget: jwidget): boolean;
declare function IssueInstantTargetOrder(whichUnit: junit, order: string, targetWidget: jwidget, instantTargetWidget: jwidget): boolean;
declare function IssueInstantTargetOrderById(whichUnit: junit, order: number, targetWidget: jwidget, instantTargetWidget: jwidget): boolean;
declare function IssueBuildOrder(whichPeon: junit, unitToBuild: string, x: number, y: number): boolean;
declare function IssueBuildOrderById(whichPeon: junit, unitId: number, x: number, y: number): boolean;
declare function IssueNeutralImmediateOrder(forWhichPlayer: jplayer, neutralStructure: junit, unitToBuild: string): boolean;
declare function IssueNeutralImmediateOrderById(forWhichPlayer: jplayer, neutralStructure: junit, unitId: number): boolean;
declare function IssueNeutralPointOrder(forWhichPlayer: jplayer, neutralStructure: junit, unitToBuild: string, x: number, y: number): boolean;
declare function IssueNeutralPointOrderById(forWhichPlayer: jplayer, neutralStructure: junit, unitId: number, x: number, y: number): boolean;
declare function IssueNeutralTargetOrder(forWhichPlayer: jplayer, neutralStructure: junit, unitToBuild: string, target: jwidget): boolean;
declare function IssueNeutralTargetOrderById(forWhichPlayer: jplayer, neutralStructure: junit, unitId: number, target: jwidget): boolean;
...
declare function AddItemToStock(whichUnit: junit, itemId: number, currentStock: number, stockMax: number): void;
declare function AddUnitToAllStock(unitId: number, currentStock: number, stockMax: number): void;
declare function AddUnitToStock(whichUnit: junit, unitId: number, currentStock: number, stockMax: number): void;
...
declare function GetPlayerTypedUnitCount(whichPlayer: jplayer, unitName: string, includeIncomplete: boolean, includeUpgrades: boolean): number;
...
declare function GetPlayerAlliance(sourcePlayer: jplayer, otherPlayer: jplayer, whichAllianceSetting: jalliancetype): boolean;
...
declare function SetPlayerTechMaxAllowed(whichPlayer: jplayer, techid: number, maximum: number): void;
...
declare function SetPlayerTechResearched(whichPlayer: jplayer, techid: number, setToLevel: number): void;
declare function GetPlayerTechResearched(whichPlayer: jplayer, techid: number, specificonly: boolean): boolean;
declare function GetPlayerTechCount(whichPlayer: jplayer, techid: number, specificonly: boolean): number;
...
declare function SetPlayerAbilityAvailable(whichPlayer: jplayer, abilid: number, avail: boolean): void;
declare function SetPlayerState(whichPlayer: jplayer, whichPlayerState: jplayerstate, value: number): void;
...
declare function SetFogStateRect(forWhichPlayer: jplayer, whichState: jfogstate, where: jrect, useSharedVision: boolean): void;
declare function SetFogStateRadius(forWhichPlayer: jplayer, whichState: jfogstate, centerx: number, centerY: number, radius: number, useSharedVision: boolean): void;
declare function SetFogStateRadiusLoc(forWhichPlayer: jplayer, whichState: jfogstate, center: jlocation, radius: number, useSharedVision: boolean): void;
...
declare function CreateFogModifierRect(forWhichPlayer: jplayer, whichState: jfogstate, where: jrect, useSharedVision: boolean, afterUnits: boolean): jfogmodifier;
declare function CreateFogModifierRadius(forWhichPlayer: jplayer, whichState: jfogstate, centerx: number, centerY: number, radius: number, useSharedVision: boolean, afterUnits: boolean): jfogmodifier;
declare function CreateFogModifierRadiusLoc(forWhichPlayer: jplayer, whichState: jfogstate, center: jlocation, radius: number, useSharedVision: boolean, afterUnits: boolean): jfogmodifier;
...
declare function DialogAddQuitButton(whichDialog: jdialog, doScoreScreen: boolean, buttonText: string, hotkey: number): jbutton;
...
declare function StoreInteger(cache: jgamecache, missionKey: string, key: string, value: number): void;
declare function StoreReal(cache: jgamecache, missionKey: string, key: string, value: number): void;
declare function StoreBoolean(cache: jgamecache, missionKey: string, key: string, value: boolean): void;
declare function StoreUnit(cache: jgamecache, missionKey: string, key: string, whichUnit: junit): boolean;
declare function StoreString(cache: jgamecache, missionKey: string, key: string, value: string): boolean;
...
declare function RestoreUnit(cache: jgamecache, missionKey: string, key: string, forWhichPlayer: jplayer, x: number, y: number, facing: number): junit;
declare function InitHashtable(): jhashtable;
declare function SaveInteger(table: jhashtable, parentKey: number, childKey: number, value: number): void;
declare function SaveReal(table: jhashtable, parentKey: number, childKey: number, value: number): void;
declare function SaveBoolean(table: jhashtable, parentKey: number, childKey: number, value: boolean): void;
declare function SaveStr(table: jhashtable, parentKey: number, childKey: number, value: string): boolean;
declare function SavePlayerHandle(table: jhashtable, parentKey: number, childKey: number, whichPlayer: jplayer): boolean;
declare function SaveWidgetHandle(table: jhashtable, parentKey: number, childKey: number, whichWidget: jwidget): boolean;
declare function SaveDestructableHandle(table: jhashtable, parentKey: number, childKey: number, whichDestructable: jdestructable): boolean;
declare function SaveItemHandle(table: jhashtable, parentKey: number, childKey: number, whichItem: jitem): boolean;
declare function SaveUnitHandle(table: jhashtable, parentKey: number, childKey: number, whichUnit: junit): boolean;
declare function SaveAbilityHandle(table: jhashtable, parentKey: number, childKey: number, whichAbility: jability): boolean;
declare function SaveTimerHandle(table: jhashtable, parentKey: number, childKey: number, whichTimer: jtimer): boolean;
declare function SaveTriggerHandle(table: jhashtable, parentKey: number, childKey: number, whichTrigger: jtrigger): boolean;
declare function SaveTriggerConditionHandle(table: jhashtable, parentKey: number, childKey: number, whichTriggercondition: jtriggercondition): boolean;
declare function SaveTriggerActionHandle(table: jhashtable, parentKey: number, childKey: number, whichTriggeraction: jtriggeraction): boolean;
declare function SaveTriggerEventHandle(table: jhashtable, parentKey: number, childKey: number, whichEvent: jevent): boolean;
declare function SaveForceHandle(table: jhashtable, parentKey: number, childKey: number, whichForce: jforce): boolean;
declare function SaveGroupHandle(table: jhashtable, parentKey: number, childKey: number, whichGroup: jgroup): boolean;
declare function SaveLocationHandle(table: jhashtable, parentKey: number, childKey: number, whichLocation: jlocation): boolean;
declare function SaveRectHandle(table: jhashtable, parentKey: number, childKey: number, whichRect: jrect): boolean;
declare function SaveBooleanExprHandle(table: jhashtable, parentKey: number, childKey: number, whichBoolexpr: jboolexpr): boolean;
declare function SaveSoundHandle(table: jhashtable, parentKey: number, childKey: number, whichSound: jsound): boolean;
declare function SaveEffectHandle(table: jhashtable, parentKey: number, childKey: number, whichEffect: jeffect): boolean;
declare function SaveUnitPoolHandle(table: jhashtable, parentKey: number, childKey: number, whichUnitpool: junitpool): boolean;
declare function SaveItemPoolHandle(table: jhashtable, parentKey: number, childKey: number, whichItempool: jitempool): boolean;
declare function SaveQuestHandle(table: jhashtable, parentKey: number, childKey: number, whichQuest: jquest): boolean;
declare function SaveQuestItemHandle(table: jhashtable, parentKey: number, childKey: number, whichQuestitem: jquestitem): boolean;
declare function SaveDefeatConditionHandle(table: jhashtable, parentKey: number, childKey: number, whichDefeatcondition: jdefeatcondition): boolean;
declare function SaveTimerDialogHandle(table: jhashtable, parentKey: number, childKey: number, whichTimerdialog: jtimerdialog): boolean;
declare function SaveLeaderboardHandle(table: jhashtable, parentKey: number, childKey: number, whichLeaderboard: jleaderboard): boolean;
declare function SaveMultiboardHandle(table: jhashtable, parentKey: number, childKey: number, whichMultiboard: jmultiboard): boolean;
declare function SaveMultiboardItemHandle(table: jhashtable, parentKey: number, childKey: number, whichMultiboarditem: jmultiboarditem): boolean;
declare function SaveTrackableHandle(table: jhashtable, parentKey: number, childKey: number, whichTrackable: jtrackable): boolean;
declare function SaveDialogHandle(table: jhashtable, parentKey: number, childKey: number, whichDialog: jdialog): boolean;
declare function SaveButtonHandle(table: jhashtable, parentKey: number, childKey: number, whichButton: jbutton): boolean;
declare function SaveTextTagHandle(table: jhashtable, parentKey: number, childKey: number, whichTexttag: jtexttag): boolean;
declare function SaveLightningHandle(table: jhashtable, parentKey: number, childKey: number, whichLightning: jlightning): boolean;
declare function SaveImageHandle(table: jhashtable, parentKey: number, childKey: number, whichImage: jimage): boolean;
declare function SaveUbersplatHandle(table: jhashtable, parentKey: number, childKey: number, whichUbersplat: jubersplat): boolean;
declare function SaveRegionHandle(table: jhashtable, parentKey: number, childKey: number, whichRegion: jregion): boolean;
declare function SaveFogStateHandle(table: jhashtable, parentKey: number, childKey: number, whichFogState: jfogstate): boolean;
declare function SaveFogModifierHandle(table: jhashtable, parentKey: number, childKey: number, whichFogModifier: jfogmodifier): boolean;
declare function SaveAgentHandle(table: jhashtable, parentKey: number, childKey: number, whichAgent: jagent): boolean;
declare function SaveHashtableHandle(table: jhashtable, parentKey: number, childKey: number, whichHashtable: jhashtable): boolean;
declare function SaveFrameHandle(table: jhashtable, parentKey: number, childKey: number, whichFrameHandle: jframehandle): boolean;
...
declare function LoadDestructableHandle(table: jhashtable, parentKey: number, childKey: number): jdestructable;
...
declare function LoadTriggerConditionHandle(table: jhashtable, parentKey: number, childKey: number): jtriggercondition;
declare function LoadTriggerActionHandle(table: jhashtable, parentKey: number, childKey: number): jtriggeraction;
declare function LoadTriggerEventHandle(table: jhashtable, parentKey: number, childKey: number): jevent;
...
declare function LoadLocationHandle(table: jhashtable, parentKey: number, childKey: number): jlocation;
declare function LoadRectHandle(table: jhashtable, parentKey: number, childKey: number): jrect;
declare function LoadBooleanExprHandle(table: jhashtable, parentKey: number, childKey: number): jboolexpr;
...
declare function LoadUnitPoolHandle(table: jhashtable, parentKey: number, childKey: number): junitpool;
declare function LoadItemPoolHandle(table: jhashtable, parentKey: number, childKey: number): jitempool;
declare function LoadQuestHandle(table: jhashtable, parentKey: number, childKey: number): jquest;
declare function LoadQuestItemHandle(table: jhashtable, parentKey: number, childKey: number): jquestitem;
declare function LoadDefeatConditionHandle(table: jhashtable, parentKey: number, childKey: number): jdefeatcondition;
declare function LoadTimerDialogHandle(table: jhashtable, parentKey: number, childKey: number): jtimerdialog;
declare function LoadLeaderboardHandle(table: jhashtable, parentKey: number, childKey: number): jleaderboard;
declare function LoadMultiboardHandle(table: jhashtable, parentKey: number, childKey: number): jmultiboard;
declare function LoadMultiboardItemHandle(table: jhashtable, parentKey: number, childKey: number): jmultiboarditem;
declare function LoadTrackableHandle(table: jhashtable, parentKey: number, childKey: number): jtrackable;
...
declare function LoadLightningHandle(table: jhashtable, parentKey: number, childKey: number): jlightning;
declare function LoadImageHandle(table: jhashtable, parentKey: number, childKey: number): jimage;
declare function LoadUbersplatHandle(table: jhashtable, parentKey: number, childKey: number): jubersplat;
declare function LoadRegionHandle(table: jhashtable, parentKey: number, childKey: number): jregion;
declare function LoadFogStateHandle(table: jhashtable, parentKey: number, childKey: number): jfogstate;
declare function LoadFogModifierHandle(table: jhashtable, parentKey: number, childKey: number): jfogmodifier;
declare function LoadHashtableHandle(table: jhashtable, parentKey: number, childKey: number): jhashtable;
declare function LoadFrameHandle(table: jhashtable, parentKey: number, childKey: number): jframehandle;
...
declare function PlaceRandomUnit(whichPool: junitpool, forWhichPlayer: jplayer, x: number, y: number, facing: number): junit;
...
declare function DisplayTimedTextToPlayer(toPlayer: jplayer, x: number, y: number, duration: number, message: string): void;
declare function DisplayTimedTextFromPlayer(toPlayer: jplayer, x: number, y: number, duration: number, message: string): void;
...
declare function UnitAddIndicator(whichUnit: junit, red: number, green: number, blue: number, alpha: number): void;
declare function AddIndicator(whichWidget: jwidget, red: number, green: number, blue: number, alpha: number): void;
...
declare function CreateMinimapIconOnUnit(whichUnit: junit, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
declare function CreateMinimapIconAtLoc(where: jlocation, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
declare function CreateMinimapIcon(x: number, y: number, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
...
declare function SetMinimapIconOrphanDestroy(whichMinimapIcon: jminimapicon, doDestroy: boolean): void;
...
declare function SetTextTagColor(t: jtexttag, red: number, green: number, blue: number, alpha: number): void;
...
declare function CreateTrackable(trackableModelPath: string, x: number, y: number, facing: number): jtrackable;
...
declare function DefeatConditionSetDescription(whichCondition: jdefeatcondition, description: string): void;
...
declare function TimerDialogSetTitleColor(whichDialog: jtimerdialog, red: number, green: number, blue: number, alpha: number): void;
declare function TimerDialogSetTimeColor(whichDialog: jtimerdialog, red: number, green: number, blue: number, alpha: number): void;
...
declare function TimerDialogSetRealTimeRemaining(whichDialog: jtimerdialog, timeRemaining: number): void;
...
declare function LeaderboardAddItem(lb: jleaderboard, label: string, value: number, p: jplayer): void;
...
declare function LeaderboardSetLabelColor(lb: jleaderboard, red: number, green: number, blue: number, alpha: number): void;
declare function LeaderboardSetValueColor(lb: jleaderboard, red: number, green: number, blue: number, alpha: number): void;
declare function LeaderboardSetStyle(lb: jleaderboard, showLabel: boolean, showNames: boolean, showValues: boolean, showIcons: boolean): void;
...
declare function LeaderboardSetItemStyle(lb: jleaderboard, whichItem: number, showLabel: boolean, showValue: boolean, showIcon: boolean): void;
declare function LeaderboardSetItemLabelColor(lb: jleaderboard, whichItem: number, red: number, green: number, blue: number, alpha: number): void;
declare function LeaderboardSetItemValueColor(lb: jleaderboard, whichItem: number, red: number, green: number, blue: number, alpha: number): void;
...
declare function MultiboardSetTitleTextColor(lb: jmultiboard, red: number, green: number, blue: number, alpha: number): void;
...
declare function MultiboardSetItemsStyle(lb: jmultiboard, showValues: boolean, showIcons: boolean): void;
declare function MultiboardSetItemsValue(lb: jmultiboard, value: string): void;
declare function MultiboardSetItemsValueColor(lb: jmultiboard, red: number, green: number, blue: number, alpha: number): void;
...
declare function MultiboardSetItemStyle(mbi: jmultiboarditem, showValue: boolean, showIcon: boolean): void;
declare function MultiboardSetItemValue(mbi: jmultiboarditem, val: string): void;
declare function MultiboardSetItemValueColor(mbi: jmultiboarditem, red: number, green: number, blue: number, alpha: number): void;
...
declare function SetCameraTargetController(whichUnit: junit, xoffset: number, yoffset: number, inheritOrientation: boolean): void;
...
declare function CameraSetupSetField(whichSetup: jcamerasetup, whichField: jcamerafield, value: number, duration: number): void;
declare function CameraSetupGetField(whichSetup: jcamerasetup, whichField: jcamerafield): number;
declare function CameraSetupSetDestPosition(whichSetup: jcamerasetup, x: number, y: number, duration: number): void;
...
declare function CameraSetupApplyForceDuration(whichSetup: jcamerasetup, doPan: boolean, forceDuration: number): void;
declare function CameraSetupApplyForceDurationWithZ(whichSetup: jcamerasetup, zDestOffset: number, forceDuration: number): void;
...
declare function SetCinematicScene(portraitUnitId: number, color: jplayercolor, speakerTitle: string, text: string, sceneDuration: number, voiceoverDuration: number): void;
...
declare function CreateSound(fileName: string, looping: boolean, is3D: boolean, stopwhenoutofrange: boolean, fadeInRate: number, fadeOutRate: number, eaxSetting: string): jsound;
declare function CreateSoundFilenameWithLabel(fileName: string, looping: boolean, is3D: boolean, stopwhenoutofrange: boolean, fadeInRate: number, fadeOutRate: number, SLKEntryName: string): jsound;
declare function CreateSoundFromLabel(soundLabel: string, looping: boolean, is3D: boolean, stopwhenoutofrange: boolean, fadeInRate: number, fadeOutRate: number): jsound;
declare function CreateMIDISound(soundLabel: string, fadeInRate: number, fadeOutRate: number): jsound;
...
declare function SetSoundConeAngles(soundHandle: jsound, inside: number, outside: number, outsideVolume: number): void;
...
declare function RegisterStackedSound(soundHandle: jsound, byPosition: boolean, rectwidth: number, rectheight: number): void;
declare function UnregisterStackedSound(soundHandle: jsound, byPosition: boolean, rectwidth: number, rectheight: number): void;
...
declare function SetSoundFacialAnimationSetFilepath(soundHandle: jsound, animationSetFilepath: string): boolean;
...
declare function TerrainDeformCrater(x: number, y: number, radius: number, depth: number, duration: number, permanent: boolean): jterraindeformation;
declare function TerrainDeformRipple(x: number, y: number, radius: number, depth: number, duration: number, count: number, spaceWaves: number, timeWaves: number, radiusStartPct: number, limitNeg: boolean): jterraindeformation;
declare function TerrainDeformWave(x: number, y: number, dirX: number, dirY: number, distance: number, speed: number, radius: number, depth: number, trailTime: number, count: number): jterraindeformation;
declare function TerrainDeformRandom(x: number, y: number, radius: number, minDelta: number, maxDelta: number, duration: number, updateInterval: number): jterraindeformation;
...
declare function AddSpecialEffectTarget(modelName: string, targetWidget: jwidget, attachPointName: string): jeffect;
declare function DestroyEffect(whichEffect: jeffect): void;
declare function AddSpellEffect(abilityString: string, t: jeffecttype, x: number, y: number): jeffect;
declare function AddSpellEffectLoc(abilityString: string, t: jeffecttype, where: jlocation): jeffect;
declare function AddSpellEffectById(abilityId: number, t: jeffecttype, x: number, y: number): jeffect;
declare function AddSpellEffectByIdLoc(abilityId: number, t: jeffecttype, where: jlocation): jeffect;
declare function AddSpellEffectTarget(modelName: string, t: jeffecttype, targetWidget: jwidget, attachPoint: string): jeffect;
declare function AddSpellEffectTargetById(abilityId: number, t: jeffecttype, targetWidget: jwidget, attachPoint: string): jeffect;
declare function AddLightning(codeName: string, checkVisibility: boolean, x1: number, y1: number, x2: number, y2: number): jlightning;
declare function AddLightningEx(codeName: string, checkVisibility: boolean, x1: number, y1: number, z1: number, x2: number, y2: number, z2: number): jlightning;
declare function DestroyLightning(whichBolt: jlightning): boolean;
declare function MoveLightning(whichBolt: jlightning, checkVisibility: boolean, x1: number, y1: number, x2: number, y2: number): boolean;
declare function MoveLightningEx(whichBolt: jlightning, checkVisibility: boolean, x1: number, y1: number, z1: number, x2: number, y2: number, z2: number): boolean;
...
declare function SetLightningColor(whichBolt: jlightning, r: number, g: number, b: number, a: number): boolean;
...
declare function CreateImage(file: string, sizeX: number, sizeY: number, sizeZ: number, posX: number, posY: number, posZ: number, originX: number, originY: number, originZ: number, imageType: number): jimage;
...
declare function SetImageColor(whichImage: jimage, red: number, green: number, blue: number, alpha: number): void;
...
declare function CreateUbersplat(x: number, y: number, name: string, red: number, green: number, blue: number, alpha: number, forcePaused: boolean, noBirthTime: boolean): jubersplat;
...
declare function SetBlight(whichPlayer: jplayer, x: number, y: number, radius: number, addBlight: boolean): void;
declare function SetBlightRect(whichPlayer: jplayer, r: jrect, addBlight: boolean): void;
declare function SetBlightPoint(whichPlayer: jplayer, x: number, y: number, addBlight: boolean): void;
declare function SetBlightLoc(whichPlayer: jplayer, whichLocation: jlocation, radius: number, addBlight: boolean): void;
...
declare function SetDoodadAnimationRect(r: jrect, doodadID: number, animName: string, animRandom: boolean): void;
...
declare function BlzSetUnitBaseDamage(whichUnit: junit, baseDamage: number, weaponIndex: number): void;
declare function BlzGetUnitDiceNumber(whichUnit: junit, weaponIndex: number): number;
declare function BlzSetUnitDiceNumber(whichUnit: junit, diceNumber: number, weaponIndex: number): void;
...
declare function BlzSetUnitAttackCooldown(whichUnit: junit, cooldown: number, weaponIndex: number): void;
declare function BlzSetSpecialEffectColorByPlayer(whichEffect: jeffect, whichPlayer: jplayer): void;
declare function BlzSetSpecialEffectColor(whichEffect: jeffect, r: number, g: number, b: number): void;
...
declare function BlzSetSpecialEffectPosition(whichEffect: jeffect, x: number, y: number, z: number): void;
...
declare function BlzSetSpecialEffectOrientation(whichEffect: jeffect, yaw: number, pitch: number, roll: number): void;
...
declare function BlzSpecialEffectRemoveSubAnimation(whichEffect: jeffect, whichSubAnim: jsubanimtype): void;
declare function BlzSpecialEffectAddSubAnimation(whichEffect: jeffect, whichSubAnim: jsubanimtype): void;
declare function BlzPlaySpecialEffect(whichEffect: jeffect, whichAnim: janimtype): void;
declare function BlzPlaySpecialEffectWithTimeScale(whichEffect: jeffect, whichAnim: janimtype, timeScale: number): void;
...
declare function BlzUnitDisableAbility(whichUnit: junit, abilId: number, flag: boolean, hideUI: boolean): void;
...
declare function BlzSetUnitAbilityCooldown(whichUnit: junit, abilId: number, level: number, cooldown: number): void;
...
declare function BlzStartUnitAbilityCooldown(whichUnit: junit, abilCode: number, cooldown: number): void;
declare function BlzGetUnitAbilityManaCost(whichUnit: junit, abilId: number, level: number): number;
declare function BlzSetUnitAbilityManaCost(whichUnit: junit, abilId: number, level: number, manaCost: number): void;
declare function BlzGetLocalUnitZ(whichUnit: junit): number;
declare function BlzDecPlayerTechResearched(whichPlayer: jplayer, techid: number, levels: number): void;
...
declare function RequestExtraIntegerData(dataType: number, whichPlayer: jplayer, param1: string, param2: string, param3: boolean, param4: number, param5: number, param6: number): number;
declare function RequestExtraBooleanData(dataType: number, whichPlayer: jplayer, param1: string, param2: string, param3: boolean, param4: number, param5: number, param6: number): boolean;
declare function RequestExtraStringData(dataType: number, whichPlayer: jplayer, param1: string, param2: string, param3: boolean, param4: number, param5: number, param6: number): string;
declare function RequestExtraRealData(dataType: number, whichPlayer: jplayer, param1: string, param2: string, param3: boolean, param4: number, param5: number, param6: number): number;
...
declare function BlzCameraSetupApplyForceDurationSmooth(whichSetup: jcamerasetup, doPan: boolean, forcedDuration: number, easeInDuration: number, easeOutDuration: number, smoothFactor: number): void;
...
declare function BlzCreateFrame(name: string, owner: jframehandle, priority: number, createContext: number): jframehandle;
declare function BlzCreateSimpleFrame(name: string, owner: jframehandle, createContext: number): jframehandle;
declare function BlzCreateFrameByType(typeName: string, name: string, owner: jframehandle, inherits: string, createContext: number): jframehandle;
declare function BlzDestroyFrame(frame: jframehandle): void;
declare function BlzFrameSetPoint(frame: jframehandle, point: jframepointtype, relative: jframehandle, relativePoint: jframepointtype, x: number, y: number): void;
declare function BlzFrameSetAbsPoint(frame: jframehandle, point: jframepointtype, x: number, y: number): void;
...
declare function BlzFrameSetSpriteAnimate(frame: jframehandle, primaryProp: number, flags: number): void;
declare function BlzFrameSetTexture(frame: jframehandle, texFile: string, flag: number, blend: boolean): void;
...
declare function BlzFrameSetMinMaxValue(frame: jframehandle, minValue: number, maxValue: number): void;
...
declare function BlzFrameSetFont(frame: jframehandle, fileName: string, height: number, flags: number): void;
declare function BlzFrameSetTextAlignment(frame: jframehandle, vert: jtextaligntype, horz: jtextaligntype): void;
declare function BlzTriggerRegisterFrameEvent(whichTrigger: jtrigger, frame: jframehandle, eventId: jframeeventtype): jevent;
...
declare function BlzTriggerRegisterPlayerSyncEvent(whichTrigger: jtrigger, whichPlayer: jplayer, prefix: string, fromServer: boolean): jevent;
...
declare function BlzTriggerRegisterPlayerKeyEvent(whichTrigger: jtrigger, whichPlayer: jplayer, key: joskeytype, metaKey: number, keyDown: boolean): jevent;
...
declare function BlzSetSpecialEffectMatrixScale(whichEffect: jeffect, x: number, y: number, z: number): void;
...
declare function BlzDisplayChatMessage(whichPlayer: jplayer, recipient: number, message: string): void;
...
declare function BlzGetAbilityBooleanField(whichAbility: jability, whichField: jabilitybooleanfield): boolean;
declare function BlzGetAbilityIntegerField(whichAbility: jability, whichField: jabilityintegerfield): number;
declare function BlzGetAbilityRealField(whichAbility: jability, whichField: jabilityrealfield): number;
declare function BlzGetAbilityStringField(whichAbility: jability, whichField: jabilitystringfield): string;
declare function BlzGetAbilityBooleanLevelField(whichAbility: jability, whichField: jabilitybooleanlevelfield, level: number): boolean;
declare function BlzGetAbilityIntegerLevelField(whichAbility: jability, whichField: jabilityintegerlevelfield, level: number): number;
declare function BlzGetAbilityRealLevelField(whichAbility: jability, whichField: jabilityreallevelfield, level: number): number;
declare function BlzGetAbilityStringLevelField(whichAbility: jability, whichField: jabilitystringlevelfield, level: number): string;
declare function BlzGetAbilityBooleanLevelArrayField(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, index: number): boolean;
declare function BlzGetAbilityIntegerLevelArrayField(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, index: number): number;
declare function BlzGetAbilityRealLevelArrayField(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, index: number): number;
declare function BlzGetAbilityStringLevelArrayField(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, index: number): string;
declare function BlzSetAbilityBooleanField(whichAbility: jability, whichField: jabilitybooleanfield, value: boolean): boolean;
declare function BlzSetAbilityIntegerField(whichAbility: jability, whichField: jabilityintegerfield, value: number): boolean;
declare function BlzSetAbilityRealField(whichAbility: jability, whichField: jabilityrealfield, value: number): boolean;
declare function BlzSetAbilityStringField(whichAbility: jability, whichField: jabilitystringfield, value: string): boolean;
declare function BlzSetAbilityBooleanLevelField(whichAbility: jability, whichField: jabilitybooleanlevelfield, level: number, value: boolean): boolean;
declare function BlzSetAbilityIntegerLevelField(whichAbility: jability, whichField: jabilityintegerlevelfield, level: number, value: number): boolean;
declare function BlzSetAbilityRealLevelField(whichAbility: jability, whichField: jabilityreallevelfield, level: number, value: number): boolean;
declare function BlzSetAbilityStringLevelField(whichAbility: jability, whichField: jabilitystringlevelfield, level: number, value: string): boolean;
declare function BlzSetAbilityBooleanLevelArrayField(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, index: number, value: boolean): boolean;
declare function BlzSetAbilityIntegerLevelArrayField(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, index: number, value: number): boolean;
declare function BlzSetAbilityRealLevelArrayField(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, index: number, value: number): boolean;
declare function BlzSetAbilityStringLevelArrayField(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, index: number, value: string): boolean;
declare function BlzAddAbilityBooleanLevelArrayField(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, value: boolean): boolean;
declare function BlzAddAbilityIntegerLevelArrayField(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, value: number): boolean;
declare function BlzAddAbilityRealLevelArrayField(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, value: number): boolean;
declare function BlzAddAbilityStringLevelArrayField(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, value: string): boolean;
declare function BlzRemoveAbilityBooleanLevelArrayField(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, value: boolean): boolean;
declare function BlzRemoveAbilityIntegerLevelArrayField(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, value: number): boolean;
declare function BlzRemoveAbilityRealLevelArrayField(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, value: number): boolean;
declare function BlzRemoveAbilityStringLevelArrayField(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, value: string): boolean;
...
declare function BlzSetItemBooleanField(whichItem: jitem, whichField: jitembooleanfield, value: boolean): boolean;
declare function BlzSetItemIntegerField(whichItem: jitem, whichField: jitemintegerfield, value: number): boolean;
declare function BlzSetItemRealField(whichItem: jitem, whichField: jitemrealfield, value: number): boolean;
declare function BlzSetItemStringField(whichItem: jitem, whichField: jitemstringfield, value: string): boolean;
...
declare function BlzSetUnitBooleanField(whichUnit: junit, whichField: junitbooleanfield, value: boolean): boolean;
declare function BlzSetUnitIntegerField(whichUnit: junit, whichField: junitintegerfield, value: number): boolean;
declare function BlzSetUnitRealField(whichUnit: junit, whichField: junitrealfield, value: number): boolean;
declare function BlzSetUnitStringField(whichUnit: junit, whichField: junitstringfield, value: string): boolean;
declare function BlzGetUnitWeaponBooleanField(whichUnit: junit, whichField: junitweaponbooleanfield, index: number): boolean;
declare function BlzGetUnitWeaponIntegerField(whichUnit: junit, whichField: junitweaponintegerfield, index: number): number;
declare function BlzGetUnitWeaponRealField(whichUnit: junit, whichField: junitweaponrealfield, index: number): number;
declare function BlzGetUnitWeaponStringField(whichUnit: junit, whichField: junitweaponstringfield, index: number): string;
declare function BlzSetUnitWeaponBooleanField(whichUnit: junit, whichField: junitweaponbooleanfield, index: number, value: boolean): boolean;
declare function BlzSetUnitWeaponIntegerField(whichUnit: junit, whichField: junitweaponintegerfield, index: number, value: number): boolean;
declare function BlzSetUnitWeaponRealField(whichUnit: junit, whichField: junitweaponrealfield, index: number, value: number): boolean;
declare function BlzSetUnitWeaponStringField(whichUnit: junit, whichField: junitweaponstringfield, index: number, value: string): boolean;
...
declare function BlzCreateUnitWithSkin(id: jplayer, unitid: number, x: number, y: number, face: number, skinId: number): junit;
declare function BlzCreateDestructableWithSkin(objectid: number, x: number, y: number, face: number, scale: number, variation: number, skinId: number): jdestructable;
declare function BlzCreateDestructableZWithSkin(objectid: number, x: number, y: number, z: number, face: number, scale: number, variation: number, skinId: number): jdestructable;
declare function BlzCreateDeadDestructableWithSkin(objectid: number, x: number, y: number, face: number, scale: number, variation: number, skinId: number): jdestructable;
declare function BlzCreateDeadDestructableZWithSkin(objectid: number, x: number, y: number, z: number, face: number, scale: number, variation: number, skinId: number): jdestructable;
...
declare function CameraSetupApplyForPlayer(doPan: boolean, whichSetup: jcamerasetup, whichPlayer: jplayer, duration: number): void;
declare function CameraSetupApplyForPlayerSmooth(doPan: boolean, whichSetup: jcamerasetup, whichPlayer: jplayer, forcedDuration: number, easeInDuration: number, easeOutDuration: number, smoothFactor: number): void;
declare function CameraSetupGetFieldSwap(whichField: jcamerafield, whichSetup: jcamerasetup): number;
declare function SetCameraFieldForPlayer(whichPlayer: jplayer, whichField: jcamerafield, value: number, duration: number): void;
declare function SetCameraTargetControllerNoZForPlayer(whichPlayer: jplayer, whichUnit: junit, xoffset: number, yoffset: number, inheritOrientation: boolean): void;
...
declare function RotateCameraAroundLocBJ(degrees: number, loc: jlocation, whichPlayer: jplayer, duration: number): void;
...
declare function PanCameraToTimedForPlayer(whichPlayer: jplayer, x: number, y: number, duration: number): void;
declare function PanCameraToTimedLocForPlayer(whichPlayer: jplayer, loc: jlocation, duration: number): void;
declare function PanCameraToTimedLocWithZForPlayer(whichPlayer: jplayer, loc: jlocation, zOffset: number, duration: number): void;
...
declare function CameraSetSourceNoiseForPlayer(whichPlayer: jplayer, magnitude: number, velocity: number): void;
declare function CameraSetTargetNoiseForPlayer(whichPlayer: jplayer, magnitude: number, velocity: number): void;
...
declare function AdjustCameraBoundsForPlayerBJ(adjustMethod: number, whichPlayer: jplayer, dxWest: number, dxEast: number, dyNorth: number, dySouth: number): void;
...
declare function SetCameraOrientControllerForPlayerBJ(whichPlayer: jplayer, whichUnit: junit, xoffset: number, yoffset: number): void;
...
declare function TriggerRegisterPlayerUnitEventSimple(trig: jtrigger, whichPlayer: jplayer, whichEvent: jplayerunitevent): jevent;
declare function TriggerRegisterAnyUnitEventBJ(trig: jtrigger, whichEvent: jplayerunitevent): void;
declare function TriggerRegisterPlayerSelectionEventBJ(trig: jtrigger, whichPlayer: jplayer, selected: boolean): jevent;
declare function TriggerRegisterPlayerKeyEventBJ(trig: jtrigger, whichPlayer: jplayer, keType: number, keKey: number): jevent;
declare function TriggerRegisterPlayerMouseEventBJ(trig: jtrigger, whichPlayer: jplayer, meType: number): jevent;
...
declare function TriggerRegisterPlayerEventAllianceChanged(trig: jtrigger, whichPlayer: jplayer): jevent;
declare function TriggerRegisterPlayerEventEndCinematic(trig: jtrigger, whichPlayer: jplayer): jevent;
declare function TriggerRegisterGameStateEventTimeOfDay(trig: jtrigger, opcode: jlimitop, limitval: number): jevent;
...
declare function TriggerRegisterDistanceBetweenUnits(trig: jtrigger, whichUnit: junit, condition: jboolexpr, range: number): jevent;
declare function TriggerRegisterUnitInRangeSimple(trig: jtrigger, range: number, whichUnit: junit): jevent;
declare function TriggerRegisterUnitLifeEvent(trig: jtrigger, whichUnit: junit, opcode: jlimitop, limitval: number): jevent;
declare function TriggerRegisterUnitManaEvent(trig: jtrigger, whichUnit: junit, opcode: jlimitop, limitval: number): jevent;
...
declare function TerrainDeformationCraterBJ(duration: number, permanent: boolean, where: jlocation, radius: number, depth: number): jterraindeformation;
declare function TerrainDeformationRippleBJ(duration: number, limitNeg: boolean, where: jlocation, startRadius: number, endRadius: number, depth: number, wavePeriod: number, waveWidth: number): jterraindeformation;
declare function TerrainDeformationWaveBJ(duration: number, source: jlocation, target: jlocation, radius: number, depth: number, trailDelay: number): jterraindeformation;
declare function TerrainDeformationRandomBJ(duration: number, where: jlocation, radius: number, minDelta: number, maxDelta: number, updateInterval: number): jterraindeformation;
...
declare function MoveLightningLoc(whichBolt: jlightning, where1: jlocation, where2: jlocation): boolean;
...
declare function SetLightningColorBJ(whichBolt: jlightning, r: number, g: number, b: number, a: number): boolean;
...
declare function SetTerrainTypeBJ(where: jlocation, terrainType: number, variation: number, area: number, shape: number): void;
...
declare function CreateFogModifierRectSimple(whichPlayer: jplayer, whichFogState: jfogstate, r: jrect, afterUnits: boolean): jfogmodifier;
declare function CreateFogModifierRadiusLocSimple(whichPlayer: jplayer, whichFogState: jfogstate, center: jlocation, radius: number, afterUnits: boolean): jfogmodifier;
declare function CreateFogModifierRectBJ(enabled: boolean, whichPlayer: jplayer, whichFogState: jfogstate, r: jrect): jfogmodifier;
declare function CreateFogModifierRadiusLocBJ(enabled: boolean, whichPlayer: jplayer, whichFogState: jfogstate, center: jlocation, radius: number): jfogmodifier;
...
declare function SetDoodadAnimationBJ(animName: string, doodadID: number, radius: number, center: jlocation): void;
declare function SetDoodadAnimationRectBJ(animName: string, doodadID: number, r: jrect): void;
declare function AddUnitAnimationPropertiesBJ(add: boolean, animProperties: string, whichUnit: junit): void;
declare function CreateImageBJ(file: string, size: number, where: jlocation, zOffset: number, imageType: number): jimage;
...
declare function SetImageColorBJ(whichImage: jimage, red: number, green: number, blue: number, alpha: number): void;
declare function GetLastCreatedImage(): jimage;
declare function CreateUbersplatBJ(where: jlocation, name: string, red: number, green: number, blue: number, alpha: number, forcePaused: boolean, noBirthTime: boolean): jubersplat;
...
declare function CreateMinimapIconOnUnitBJ(whichUnit: junit, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
declare function CreateMinimapIconAtLocBJ(where: jlocation, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
declare function CreateMinimapIconBJ(x: number, y: number, red: number, green: number, blue: number, pingPath: string, fogVisibility: jfogstate): jminimapicon;
...
declare function SetSoundConeAnglesBJ(soundHandle: jsound, inside: number, outside: number, outsideVolumePercent: number): void;
declare function KillSoundWhenDoneBJ(soundHandle: jsound): void;
declare function PlaySoundAtPointBJ(soundHandle: jsound, volumePercent: number, loc: jlocation, z: number): void;
declare function PlaySoundOnUnitBJ(soundHandle: jsound, volumePercent: number, whichUnit: junit): void;
declare function PlaySoundFromOffsetBJ(soundHandle: jsound, volumePercent: number, startingOffset: number): void;
...
declare function VolumeGroupSetVolumeForPlayerBJ(whichPlayer: jplayer, vgroup: jvolumegroup, scale: number): void;
...
declare function AddSpecialEffectTargetUnitBJ(attachPointName: string, targetWidget: jwidget, modelName: string): jeffect;
...
declare function SetUnitAbilityLevelSwapped(abilcode: number, whichUnit: junit, level: number): number;
...
declare function ModifyHeroStat(whichStat: number, whichHero: junit, modifyMethod: number, value: number): void;
declare function ModifyHeroSkillPoints(whichHero: junit, modifyMethod: number, value: number): boolean;
declare function UnitDropItemPointBJ(whichUnit: junit, whichItem: jitem, x: number, y: number): boolean;
...
declare function UnitUseItemDestructable(whichUnit: junit, whichItem: jitem, target: jwidget): boolean;
...
declare function CreateUnitAtLocSaveLast(id: jplayer, unitid: number, loc: jlocation, face: number): junit;
declare function GetLastCreatedUnit(): junit;
declare function CreateNUnitsAtLoc(count: number, unitId: number, whichPlayer: jplayer, loc: jlocation, face: number): jgroup;
declare function CreateNUnitsAtLocFacingLocBJ(count: number, unitId: number, whichPlayer: jplayer, loc: jlocation, lookAt: jlocation): jgroup;
...
declare function CreatePermanentCorpseLocBJ(style: number, unitid: number, whichPlayer: jplayer, loc: jlocation, facing: number): junit;
declare function GetUnitStateSwap(whichState: junitstate, whichUnit: junit): number;
declare function GetUnitStatePercent(whichUnit: junit, whichState: junitstate, whichMaxState: junitstate): number;
...
declare function UnitRemoveBuffsExBJ(polarity: number, resist: number, whichUnit: junit, bTLife: boolean, bAura: boolean): void;
declare function UnitCountBuffsExBJ(polarity: number, resist: number, whichUnit: junit, bTLife: boolean, bAura: boolean): number;
...
declare function UnitMakeAbilityPermanentBJ(permanent: boolean, abilityId: number, whichUnit: junit): boolean;
...
declare function SetUnitPositionLocFacingLocBJ(whichUnit: junit, loc: jlocation, lookAt: jlocation): void;
declare function AddItemToStockBJ(itemId: number, whichUnit: junit, currentStock: number, stockMax: number): void;
declare function AddUnitToStockBJ(unitId: number, whichUnit: junit, currentStock: number, stockMax: number): void;
...
declare function UnitDamagePointLoc(whichUnit: junit, delay: number, radius: number, loc: jlocation, amount: number, whichAttack: jattacktype, whichDamage: jdamagetype): boolean;
declare function UnitDamageTargetBJ(whichUnit: junit, target: junit, amount: number, whichAttack: jattacktype, whichDamage: jdamagetype): boolean;
declare function CreateDestructableLoc(objectid: number, loc: jlocation, facing: number, scale: number, variation: number): jdestructable;
declare function CreateDeadDestructableLocBJ(objectid: number, loc: jlocation, facing: number, scale: number, variation: number): jdestructable;
...
declare function EnumDestructablesInCircleBJ(radius: number, loc: jlocation, actionFunc?: () => void): void;
...
declare function EnumUnitsSelected(whichPlayer: jplayer, enumFilter: jboolexpr, enumAction?: () => void): void;
...
declare function GetUnitsInRangeOfLocMatching(radius: number, whichLocation: jlocation, filter: jboolexpr): jgroup;
...
declare function SetUnitScalePercent(whichUnit: junit, percentScaleX: number, percentScaleY: number, percentScaleZ: number): void;
declare function SetUnitVertexColorBJ(whichUnit: junit, red: number, green: number, blue: number, transparency: number): void;
declare function UnitAddIndicatorBJ(whichUnit: junit, red: number, green: number, blue: number, transparency: number): void;
declare function DestructableAddIndicatorBJ(whichDestructable: jdestructable, red: number, green: number, blue: number, transparency: number): void;
declare function ItemAddIndicatorBJ(whichItem: jitem, red: number, green: number, blue: number, transparency: number): void;
declare function SetUnitFacingToFaceLocTimed(whichUnit: junit, target: jlocation, duration: number): void;
declare function SetUnitFacingToFaceUnitTimed(whichUnit: junit, target: junit, duration: number): void;
...
declare function DialogAddButtonWithHotkeyBJ(whichDialog: jdialog, buttonText: string, hotkey: number): jbutton;
...
declare function SetPlayerAllianceBJ(sourcePlayer: jplayer, whichAllianceSetting: jalliancetype, value: boolean, otherPlayer: jplayer): void;
declare function SetPlayerAllianceStateAllyBJ(sourcePlayer: jplayer, otherPlayer: jplayer, flag: boolean): void;
declare function SetPlayerAllianceStateVisionBJ(sourcePlayer: jplayer, otherPlayer: jplayer, flag: boolean): void;
declare function SetPlayerAllianceStateControlBJ(sourcePlayer: jplayer, otherPlayer: jplayer, flag: boolean): void;
declare function SetPlayerAllianceStateFullControlBJ(sourcePlayer: jplayer, otherPlayer: jplayer, flag: boolean): void;
declare function SetPlayerAllianceStateBJ(sourcePlayer: jplayer, otherPlayer: jplayer, allianceState: number): void;
declare function SetForceAllianceStateBJ(sourceForce: jforce, targetForce: jforce, allianceState: number): void;
...
declare function RemovePlayerPreserveUnitsBJ(whichPlayer: jplayer, gameResult: jplayergameresult, leftGame: boolean): void;
...
declare function CustomVictoryBJ(whichPlayer: jplayer, showDialog: boolean, showScores: boolean): void;
...
declare function CreateQuestBJ(questType: number, title: string, description: string, iconPath: string): jquest;
...
declare function DefeatConditionSetDescriptionBJ(whichCondition: jdefeatcondition, description: string): void;
...
declare function TimerDialogSetTitleColorBJ(td: jtimerdialog, red: number, green: number, blue: number, transparency: number): void;
declare function TimerDialogSetTimeColorBJ(td: jtimerdialog, red: number, green: number, blue: number, transparency: number): void;
declare function TimerDialogSetSpeedBJ(td: jtimerdialog, speedMultFactor: number): void;
declare function TimerDialogDisplayForPlayerBJ(show: boolean, td: jtimerdialog, whichPlayer: jplayer): void;
...
declare function LeaderboardSetPlayerItemValueBJ(whichPlayer: jplayer, lb: jleaderboard, val: number): void;
declare function LeaderboardSetPlayerItemLabelBJ(whichPlayer: jplayer, lb: jleaderboard, val: string): void;
declare function LeaderboardSetPlayerItemStyleBJ(whichPlayer: jplayer, lb: jleaderboard, showLabel: boolean, showValue: boolean, showIcon: boolean): void;
declare function LeaderboardSetPlayerItemLabelColorBJ(whichPlayer: jplayer, lb: jleaderboard, red: number, green: number, blue: number, transparency: number): void;
declare function LeaderboardSetPlayerItemValueColorBJ(whichPlayer: jplayer, lb: jleaderboard, red: number, green: number, blue: number, transparency: number): void;
declare function LeaderboardSetLabelColorBJ(lb: jleaderboard, red: number, green: number, blue: number, transparency: number): void;
declare function LeaderboardSetValueColorBJ(lb: jleaderboard, red: number, green: number, blue: number, transparency: number): void;
declare function LeaderboardSetLabelBJ(lb: jleaderboard, label: string): void;
declare function LeaderboardSetStyleBJ(lb: jleaderboard, showLabel: boolean, showNames: boolean, showValues: boolean, showIcons: boolean): void;
...
declare function LeaderboardAddItemBJ(whichPlayer: jplayer, lb: jleaderboard, label: string, value: number): void;
declare function LeaderboardRemovePlayerItemBJ(whichPlayer: jplayer, lb: jleaderboard): void;
declare function LeaderboardSortItemsBJ(lb: jleaderboard, sortType: number, ascending: boolean): void;
...
declare function MultiboardSetTitleTextColorBJ(mb: jmultiboard, red: number, green: number, blue: number, transparency: number): void;
declare function MultiboardAllowDisplayBJ(flag: boolean): void;
declare function MultiboardSetItemStyleBJ(mb: jmultiboard, col: number, row: number, showValue: boolean, showIcon: boolean): void;
declare function MultiboardSetItemValueBJ(mb: jmultiboard, col: number, row: number, val: string): void;
declare function MultiboardSetItemColorBJ(mb: jmultiboard, col: number, row: number, red: number, green: number, blue: number, transparency: number): void;
declare function MultiboardSetItemWidthBJ(mb: jmultiboard, col: number, row: number, width: number): void;
declare function MultiboardSetItemIconBJ(mb: jmultiboard, col: number, row: number, iconFileName: string): void;
declare function TextTagSize2Height(size: number): number;
declare function TextTagSpeed2Velocity(speed: number): number;
declare function SetTextTagColorBJ(tt: jtexttag, red: number, green: number, blue: number, transparency: number): void;
...
declare function CreateTextTagLocBJ(s: string, loc: jlocation, zOffset: number, size: number, red: number, green: number, blue: number, transparency: number): jtexttag;
declare function CreateTextTagUnitBJ(s: string, whichUnit: junit, zOffset: number, size: number, red: number, green: number, blue: number, transparency: number): jtexttag;
...
declare function PingMinimapForForce(whichForce: jforce, x: number, y: number, duration: number): void;
declare function PingMinimapLocForForce(whichForce: jforce, loc: jlocation, duration: number): void;
declare function PingMinimapForPlayer(whichPlayer: jplayer, x: number, y: number, duration: number): void;
declare function PingMinimapLocForPlayer(whichPlayer: jplayer, loc: jlocation, duration: number): void;
declare function PingMinimapForForceEx(whichForce: jforce, x: number, y: number, duration: number, style: number, red: number, green: number, blue: number): void;
declare function PingMinimapLocForForceEx(whichForce: jforce, loc: jlocation, duration: number, style: number, red: number, green: number, blue: number): void;
...
declare function SetCinematicSceneBJ(soundHandle: jsound, portraitUnitId: number, color: jplayercolor, speakerTitle: string, text: string, sceneDuration: number, voiceoverDuration: number): void;
declare function GetTransmissionDuration(soundHandle: jsound, timeType: number, timeVal: number): number;
declare function WaitTransmissionDuration(soundHandle: jsound, timeType: number, timeVal: number): void;
declare function DoTransmissionBasicsXYBJ(unitId: number, color: jplayercolor, x: number, y: number, soundHandle: jsound, unitName: string, message: string, duration: number): void;
declare function TransmissionFromUnitWithNameBJ(toForce: jforce, whichUnit: junit, unitName: string, soundHandle: jsound, message: string, timeType: number, timeVal: number, wait: boolean): void;
declare function PlayDialogueFromSpeakerEx(toForce: jforce, speaker: junit, speakerType: number, soundHandle: jsound, timeType: number, timeVal: number, wait: boolean): boolean;
declare function PlayDialogueFromSpeakerTypeEx(toForce: jforce, fromPlayer: jplayer, speakerType: number, loc: jlocation, soundHandle: jsound, timeType: number, timeVal: number, wait: boolean): boolean;
declare function TransmissionFromUnitTypeWithNameBJ(toForce: jforce, fromPlayer: jplayer, unitId: number, unitName: string, loc: jlocation, soundHandle: jsound, message: string, timeType: number, timeVal: number, wait: boolean): void;
declare function GetLastTransmissionDurationBJ(): number;
declare function ForceCinematicSubtitlesBJ(flag: boolean): void;
declare function CinematicModeExBJ(cineMode: boolean, forForce: jforce, interfaceFadeTime: number): void;
...
declare function CinematicFilterGenericBJ(duration: number, bmode: jblendmode, tex: string, red0: number, green0: number, blue0: number, trans0: number, red1: number, green1: number, blue1: number, trans1: number): void;
...
declare function MakeUnitRescuableToForceBJ(whichUnit: junit, isRescuable: boolean, whichForce: jforce): void;
declare function InitRescuableBehaviorBJ(): void;
declare function SetPlayerTechResearchedSwap(techid: number, levels: number, whichPlayer: jplayer): void;
declare function SetPlayerTechMaxAllowedSwap(techid: number, maximum: number, whichPlayer: jplayer): void;
...
declare function SetPlayerAbilityAvailableBJ(avail: boolean, abilid: number, whichPlayer: jplayer): void;
...
declare function StoreRealBJ(value: number, key: string, missionKey: string, cache: jgamecache): void;
declare function StoreIntegerBJ(value: number, key: string, missionKey: string, cache: jgamecache): void;
declare function StoreBooleanBJ(value: boolean, key: string, missionKey: string, cache: jgamecache): void;
declare function StoreStringBJ(value: string, key: string, missionKey: string, cache: jgamecache): boolean;
declare function StoreUnitBJ(whichUnit: junit, key: string, missionKey: string, cache: jgamecache): boolean;
declare function SaveRealBJ(value: number, key: number, missionKey: number, table: jhashtable): void;
declare function SaveIntegerBJ(value: number, key: number, missionKey: number, table: jhashtable): void;
declare function SaveBooleanBJ(value: boolean, key: number, missionKey: number, table: jhashtable): void;
declare function SaveStringBJ(value: string, key: number, missionKey: number, table: jhashtable): boolean;
declare function SavePlayerHandleBJ(whichPlayer: jplayer, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveWidgetHandleBJ(whichWidget: jwidget, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveDestructableHandleBJ(whichDestructable: jdestructable, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveItemHandleBJ(whichItem: jitem, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveUnitHandleBJ(whichUnit: junit, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveAbilityHandleBJ(whichAbility: jability, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTimerHandleBJ(whichTimer: jtimer, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTriggerHandleBJ(whichTrigger: jtrigger, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTriggerConditionHandleBJ(whichTriggercondition: jtriggercondition, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTriggerActionHandleBJ(whichTriggeraction: jtriggeraction, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTriggerEventHandleBJ(whichEvent: jevent, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveForceHandleBJ(whichForce: jforce, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveGroupHandleBJ(whichGroup: jgroup, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveLocationHandleBJ(whichLocation: jlocation, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveRectHandleBJ(whichRect: jrect, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveBooleanExprHandleBJ(whichBoolexpr: jboolexpr, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveSoundHandleBJ(whichSound: jsound, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveEffectHandleBJ(whichEffect: jeffect, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveUnitPoolHandleBJ(whichUnitpool: junitpool, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveItemPoolHandleBJ(whichItempool: jitempool, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveQuestHandleBJ(whichQuest: jquest, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveQuestItemHandleBJ(whichQuestitem: jquestitem, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveDefeatConditionHandleBJ(whichDefeatcondition: jdefeatcondition, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTimerDialogHandleBJ(whichTimerdialog: jtimerdialog, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveLeaderboardHandleBJ(whichLeaderboard: jleaderboard, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveMultiboardHandleBJ(whichMultiboard: jmultiboard, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveMultiboardItemHandleBJ(whichMultiboarditem: jmultiboarditem, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTrackableHandleBJ(whichTrackable: jtrackable, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveDialogHandleBJ(whichDialog: jdialog, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveButtonHandleBJ(whichButton: jbutton, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveTextTagHandleBJ(whichTexttag: jtexttag, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveLightningHandleBJ(whichLightning: jlightning, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveImageHandleBJ(whichImage: jimage, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveUbersplatHandleBJ(whichUbersplat: jubersplat, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveRegionHandleBJ(whichRegion: jregion, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveFogStateHandleBJ(whichFogState: jfogstate, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveFogModifierHandleBJ(whichFogModifier: jfogmodifier, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveAgentHandleBJ(whichAgent: jagent, key: number, missionKey: number, table: jhashtable): boolean;
declare function SaveHashtableHandleBJ(whichHashtable: jhashtable, key: number, missionKey: number, table: jhashtable): boolean;
...
declare function LoadDestructableHandleBJ(key: number, missionKey: number, table: jhashtable): jdestructable;
...
declare function LoadTriggerConditionHandleBJ(key: number, missionKey: number, table: jhashtable): jtriggercondition;
declare function LoadTriggerActionHandleBJ(key: number, missionKey: number, table: jhashtable): jtriggeraction;
declare function LoadTriggerEventHandleBJ(key: number, missionKey: number, table: jhashtable): jevent;
...
declare function LoadBooleanExprHandleBJ(key: number, missionKey: number, table: jhashtable): jboolexpr;
...
declare function LoadQuestItemHandleBJ(key: number, missionKey: number, table: jhashtable): jquestitem;
declare function LoadDefeatConditionHandleBJ(key: number, missionKey: number, table: jhashtable): jdefeatcondition;
declare function LoadTimerDialogHandleBJ(key: number, missionKey: number, table: jhashtable): jtimerdialog;
declare function LoadLeaderboardHandleBJ(key: number, missionKey: number, table: jhashtable): jleaderboard;
declare function LoadMultiboardHandleBJ(key: number, missionKey: number, table: jhashtable): jmultiboard;
declare function LoadMultiboardItemHandleBJ(key: number, missionKey: number, table: jhashtable): jmultiboarditem;
declare function LoadTrackableHandleBJ(key: number, missionKey: number, table: jhashtable): jtrackable;
...
declare function LoadLightningHandleBJ(key: number, missionKey: number, table: jhashtable): jlightning;
declare function LoadImageHandleBJ(key: number, missionKey: number, table: jhashtable): jimage;
declare function LoadUbersplatHandleBJ(key: number, missionKey: number, table: jhashtable): jubersplat;
...
declare function LoadFogModifierHandleBJ(key: number, missionKey: number, table: jhashtable): jfogmodifier;
declare function LoadHashtableHandleBJ(key: number, missionKey: number, table: jhashtable): jhashtable;
declare function RestoreUnitLocFacingAngleBJ(key: string, missionKey: string, cache: jgamecache, forWhichPlayer: jplayer, loc: jlocation, facing: number): junit;
declare function RestoreUnitLocFacingPointBJ(key: string, missionKey: string, cache: jgamecache, forWhichPlayer: jplayer, loc: jlocation, lookAt: jlocation): junit;
...
declare function HaveStoredValue(key: string, valueType: number, missionKey: string, cache: jgamecache): boolean;
declare function HaveSavedValue(key: number, valueType: number, missionKey: number, table: jhashtable): boolean;
...
declare function AdjustPlayerStateSimpleBJ(whichPlayer: jplayer, whichPlayerState: jplayerstate, delta: number): void;
declare function AdjustPlayerStateBJ(delta: number, whichPlayer: jplayer, whichPlayerState: jplayerstate): void;
declare function SetPlayerStateBJ(whichPlayer: jplayer, whichPlayerState: jplayerstate, value: number): void;
declare function SetPlayerFlagBJ(whichPlayerFlag: jplayerstate, flag: boolean, whichPlayer: jplayer): void;
declare function SetPlayerTaxRateBJ(rate: number, whichResource: jplayerstate, sourcePlayer: jplayer, otherPlayer: jplayer): void;
declare function GetPlayerTaxRateBJ(whichResource: jplayerstate, sourcePlayer: jplayer, otherPlayer: jplayer): number;
...
declare function SetPlayerColorBJ(whichPlayer: jplayer, color: jplayercolor, changeExisting: boolean): void;
declare function SetPlayerUnitAvailableBJ(unitId: number, allowed: boolean, whichPlayer: jplayer): void;
...
declare function IssuePointOrderLocBJ(whichUnit: junit, order: string, whichLocation: jlocation): boolean;
declare function IssueTargetDestructableOrder(whichUnit: junit, order: string, targetWidget: jwidget): boolean;
declare function IssueTargetItemOrder(whichUnit: junit, order: string, targetWidget: jwidget): boolean;
declare function IssueImmediateOrderBJ(whichUnit: junit, order: string): boolean;
declare function GroupTargetOrderBJ(whichGroup: jgroup, order: string, targetWidget: jwidget): boolean;
declare function GroupPointOrderLocBJ(whichGroup: jgroup, order: string, whichLocation: jlocation): boolean;
declare function GroupImmediateOrderBJ(whichGroup: jgroup, order: string): boolean;
declare function GroupTargetDestructableOrder(whichGroup: jgroup, order: string, targetWidget: jwidget): boolean;
declare function GroupTargetItemOrder(whichGroup: jgroup, order: string, targetWidget: jwidget): boolean;
...
declare function SetBlightRadiusLocBJ(addBlight: boolean, whichPlayer: jplayer, loc: jlocation, radius: number): void;
...
declare function ReducePlayerTechMaxAllowed(whichPlayer: jplayer, techId: number, limit: number): void;
...
declare function MeleeRandomHeroLoc(p: jplayer, id1: number, id2: number, id3: number, id4: number, loc: jlocation): junit;
declare function MeleeGetProjectedLoc(src: jlocation, targ: jlocation, distance: number, deltaAngle: number): jlocation;
...
declare function MeleeStartingUnitsHuman(whichPlayer: jplayer, startLoc: jlocation, doHeroes: boolean, doCamera: boolean, doPreload: boolean): void;
declare function MeleeStartingUnitsOrc(whichPlayer: jplayer, startLoc: jlocation, doHeroes: boolean, doCamera: boolean, doPreload: boolean): void;
declare function MeleeStartingUnitsUndead(whichPlayer: jplayer, startLoc: jlocation, doHeroes: boolean, doCamera: boolean, doPreload: boolean): void;
declare function MeleeStartingUnitsNightElf(whichPlayer: jplayer, startLoc: jlocation, doHeroes: boolean, doCamera: boolean, doPreload: boolean): void;
declare function MeleeStartingUnitsUnknownRace(whichPlayer: jplayer, startLoc: jlocation, doHeroes: boolean, doCamera: boolean, doPreload: boolean): void;
declare function MeleeStartingUnits(): void;
declare function MeleeStartingUnitsForPlayer(whichRace: jrace, whichPlayer: jplayer, loc: jlocation, doHeroes: boolean): void;
...
declare function BlzSetAbilityBooleanFieldBJ(whichAbility: jability, whichField: jabilitybooleanfield, value: boolean): void;
declare function BlzSetAbilityIntegerFieldBJ(whichAbility: jability, whichField: jabilityintegerfield, value: number): void;
declare function BlzSetAbilityRealFieldBJ(whichAbility: jability, whichField: jabilityrealfield, value: number): void;
declare function BlzSetAbilityStringFieldBJ(whichAbility: jability, whichField: jabilitystringfield, value: string): void;
declare function BlzSetAbilityBooleanLevelFieldBJ(whichAbility: jability, whichField: jabilitybooleanlevelfield, level: number, value: boolean): void;
declare function BlzSetAbilityIntegerLevelFieldBJ(whichAbility: jability, whichField: jabilityintegerlevelfield, level: number, value: number): void;
declare function BlzSetAbilityRealLevelFieldBJ(whichAbility: jability, whichField: jabilityreallevelfield, level: number, value: number): void;
declare function BlzSetAbilityStringLevelFieldBJ(whichAbility: jability, whichField: jabilitystringlevelfield, level: number, value: string): void;
declare function BlzSetAbilityBooleanLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, index: number, value: boolean): void;
declare function BlzSetAbilityIntegerLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, index: number, value: number): void;
declare function BlzSetAbilityRealLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, index: number, value: number): void;
declare function BlzSetAbilityStringLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, index: number, value: string): void;
declare function BlzAddAbilityBooleanLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, value: boolean): void;
declare function BlzAddAbilityIntegerLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, value: number): void;
declare function BlzAddAbilityRealLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, value: number): void;
declare function BlzAddAbilityStringLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, value: string): void;
declare function BlzRemoveAbilityBooleanLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitybooleanlevelarrayfield, level: number, value: boolean): void;
declare function BlzRemoveAbilityIntegerLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityintegerlevelarrayfield, level: number, value: number): void;
declare function BlzRemoveAbilityRealLevelArrayFieldBJ(whichAbility: jability, whichField: jabilityreallevelarrayfield, level: number, value: number): void;
declare function BlzRemoveAbilityStringLevelArrayFieldBJ(whichAbility: jability, whichField: jabilitystringlevelarrayfield, level: number, value: string): void;
...
declare function BlzSetItemBooleanFieldBJ(whichItem: jitem, whichField: jitembooleanfield, value: boolean): void;
declare function BlzSetItemIntegerFieldBJ(whichItem: jitem, whichField: jitemintegerfield, value: number): void;
declare function BlzSetItemRealFieldBJ(whichItem: jitem, whichField: jitemrealfield, value: number): void;
declare function BlzSetItemStringFieldBJ(whichItem: jitem, whichField: jitemstringfield, value: string): void;
declare function BlzSetUnitBooleanFieldBJ(whichUnit: junit, whichField: junitbooleanfield, value: boolean): void;
declare function BlzSetUnitIntegerFieldBJ(whichUnit: junit, whichField: junitintegerfield, value: number): void;
declare function BlzSetUnitRealFieldBJ(whichUnit: junit, whichField: junitrealfield, value: number): void;
declare function BlzSetUnitStringFieldBJ(whichUnit: junit, whichField: junitstringfield, value: string): void;
declare function BlzSetUnitWeaponBooleanFieldBJ(whichUnit: junit, whichField: junitweaponbooleanfield, index: number, value: boolean): void;
declare function BlzSetUnitWeaponIntegerFieldBJ(whichUnit: junit, whichField: junitweaponintegerfield, index: number, value: number): void;
declare function BlzSetUnitWeaponRealFieldBJ(whichUnit: junit, whichField: junitweaponrealfield, index: number, value: number): void;
declare function BlzSetUnitWeaponStringFieldBJ(whichUnit: junit, whichField: junitweaponstringfield, index: number, value: string): void;
